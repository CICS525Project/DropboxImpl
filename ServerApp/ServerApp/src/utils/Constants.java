...
public class Constants {
	...
	// public static final String URL =
	// "jdbc:sqlserver://XXXXX.database.windows.net;";
	// public static final String USER = "cics525";
	// public static final String PASSWORD = "MSSgroup6";
	// public static final String DRIVER =
	// "com.microsoft.sqlserver.jdbc.SQLServerDriver";
	// public static final String SQLSERVER = "XXXXX";
	...
	// Harry's Azure Account
	// public static final String URL =
	// "jdbc:sqlserver://yyyyyyyj.database.windows.net;";
	// public static final String USER = "cics525";
	// public static final String PASSWORD = "MSSgroup6";
	// public static final String DRIVER =
	// "com.microsoft.sqlserver.jdbc.SQLServerDriver";
	// public static final String SQLSERVER = "yyyyyyyy";
