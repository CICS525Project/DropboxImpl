...
/**
 * ClassName: Constants
 * Holds all the Constant Values for the Entire Application
 * @author Jitin
 *
 */
...
/**
 * Constants for Service 1 Server
 * Jitin Azure Account
 */
...
//	 public static final String CONTAINER ="service1";
	...
	/**
	 * Constants for Service 2 Server
	 * Jitin Azure Account
	 */
	 public static final String URL =
	 "jdbc:sqlserver://r8n9umoc58.database.windows.net;";
	 ...
	 /**
	  * Constants for Service 3 Server
	  * Ignacio Azure Account
	  */
...
//	public static final String CONTAINER = "service3";
	 ...
	 /**
	  * Constants for Service 4 Server
	  * Harry Azure Account
	  */
    // public static final String URL =
